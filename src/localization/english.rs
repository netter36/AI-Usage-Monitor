...
pub(super) const STRINGS: Strings = Strings {
    ...
    gemini_window_title: "Gemini CLI Usage Monitor",
    gemini_token_expired_title: "Gemini Auth Error",
    gemini_token_expired_body: "Run 'gemini' in a terminal to authenticate. After that, refresh or restart this app.",
    antigravity_window_title: "Antigravity Usage Monitor",
    antigravity_not_running_title: "Antigravity Not Running",
    antigravity_not_running_body: "Antigravity is not currently running. Start Antigravity to monitor usage.",
    second_suffix: "s",
};
