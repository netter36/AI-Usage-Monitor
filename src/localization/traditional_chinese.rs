...
pub(super) const STRINGS: Strings = Strings {
    ...
    gemini_window_title: "Gemini CLI 使用量監控",
    gemini_token_expired_title: "Gemini 驗證錯誤",
    gemini_token_expired_body: "請在終端機中執行 'gemini' 進行驗證。完成後，請重新整理或重新啟動此應用程式。",
    antigravity_window_title: "Antigravity 使用量監控",
    antigravity_not_running_title: "Antigravity 未執行",
    antigravity_not_running_body: "Antigravity 目前未執行。請啟動 Antigravity 以監控使用量。",
    second_suffix: "秒",
};
