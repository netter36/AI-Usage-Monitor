...
pub(super) const STRINGS: Strings = Strings {
    ...
    gemini_window_title: "Gemini CLI 사용량 모니터",
    gemini_token_expired_title: "Gemini 인증 오류",
    gemini_token_expired_body: "터미널에서 'gemini'를 실행하여 인증하세요. 그런 다음 이 앱을 새로 고치거나 다시 시작하세요.",
    antigravity_window_title: "Antigravity 사용량 모니터",
    antigravity_not_running_title: "Antigravity 미실행",
    antigravity_not_running_body: "Antigravity가 현재 실행 중이 아닙니다. 사용량을 모니터링하려면 Antigravity를 시작하세요.",
    second_suffix: "초",
};
