...
pub(super) const STRINGS: Strings = Strings {
    window_title: "AI Gebruiksmonitor",
    refresh: "Vernieuwen",
    ...
    gemini_window_title: "Gemini CLI-gebruiksmonitor",
    gemini_token_expired_title: "Gemini-authenticatiefout",
    gemini_token_expired_body: "Voer 'gemini' uit in een terminal om te authenticeren. Ververs of herstart de app daarna.",
    antigravity_window_title: "Antigravity-gebruiksmonitor",
    antigravity_not_running_title: "Antigravity draait niet",
    antigravity_not_running_body: "Antigravity draait momenteel niet. Start Antigravity om het gebruik te monitoren.",
    second_suffix: "s",
};
