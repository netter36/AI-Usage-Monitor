...
pub(super) const STRINGS: Strings = Strings {
    window_title: "AI Nutzungsmonitor",
    ...
    gemini_window_title: "Gemini CLI-Nutzungsmonitor",
    gemini_token_expired_title: "Gemini-Authentifizierungsfehler",
    gemini_token_expired_body: "Fuhren Sie 'gemini' in einem Terminal aus, um sich zu authentifizieren. Aktualisieren oder starten Sie diese App anschliessend neu.",
    antigravity_window_title: "Antigravity-Nutzungsmonitor",
    antigravity_not_running_title: "Antigravity wird nicht ausgefuhrt",
    antigravity_not_running_body: "Antigravity wird derzeit nicht ausgefuhrt. Starten Sie Antigravity, um die Nutzung zu uberwachen.",
    second_suffix: "s",
};
