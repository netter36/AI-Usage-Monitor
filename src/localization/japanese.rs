...
pub(super) const STRINGS: Strings = Strings {
    ...
    gemini_window_title: "Gemini CLI 使用量モニター",
    gemini_token_expired_title: "Gemini 認証エラー",
    gemini_token_expired_body: "ターミナルで 'gemini' を実行して認証してください。その後、このアプリを更新するか再起動してください。",
    antigravity_window_title: "Antigravity 使用量モニター",
    antigravity_not_running_title: "Antigravity が実行されていません",
    antigravity_not_running_body: "Antigravity は現在実行されていません。使用量を監視するには Antigravity を起動してください。",
    second_suffix: "秒",
};
