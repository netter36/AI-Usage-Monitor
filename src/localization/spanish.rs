...
pub(super) const STRINGS: Strings = Strings {
    window_title: "Monitor de uso de AI",
    refresh: "Actualizar",
    ...
    gemini_window_title: "Monitor de uso de Gemini CLI",
    gemini_token_expired_title: "Error de autenticacion de Gemini",
    gemini_token_expired_body: "Ejecuta 'gemini' en una terminal para autenticarte. Despues, actualiza o reinicia esta aplicacion.",
    antigravity_window_title: "Monitor de uso de Antigravity",
    antigravity_not_running_title: "Antigravity no esta en ejecucion",
    antigravity_not_running_body: "Antigravity no se esta ejecutando actualmente. Inicia Antigravity para monitorear el uso.",
    second_suffix: "s",
};
