...
pub(super) const STRINGS: Strings = Strings {
    window_title: "Moniteur d'utilisation AI",
    refresh: "Actualiser",
    ...
    gemini_window_title: "Moniteur d'utilisation Gemini CLI",
    gemini_token_expired_title: "Erreur d'authentification Gemini",
    gemini_token_expired_body: "Executez 'gemini' dans un terminal pour vous authentifier. Ensuite, actualisez ou redemarrez cette application.",
    antigravity_window_title: "Moniteur d'utilisation Antigravity",
    antigravity_not_running_title: "Antigravity n'est pas en cours d'execution",
    antigravity_not_running_body: "Antigravity n'est pas en cours d'execution. Demarrez Antigravity pour surveiller l'utilisation.",
    second_suffix: "s",
};
